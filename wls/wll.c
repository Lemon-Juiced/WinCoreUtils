...
/**
 * This is a simple wrapper around wls.exe that allows it to be invoked as "wll" or "wll.exe" to enable the long listing format by default.
 * 
 * Usage:
 *  wll [directory]
 * 
